            ...
            <div class="row my-5">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <a href="{{route('products', ['category_id'=>$category->id])}}">
                        <div class="team__items text-start  hover-zoom m-3" style="border-radius: 20px; margin: auto">
                            {{-- <div class="m-3">
                                <img class="" title="{{$category->title}}" style="max-height: 130px !important; height: 130px !important; width: 260px !important; border-radius:20px !important;" src="{{ asset('images/category/'.$category->image ) }}" alt="{{$category->title}}">
                            </div> --}}

                            <div class="team__content" style=" background-image: url({{ asset('images/category/'.$category->image ) }});" >
                            {{$category->title}}
                            <h5 class="fw-bold"></h5>
                            </div>
...
@media only screen and (max-width: 991px){.team__content{
    background-size: cover;
    ...
    <div class="container-fluid">
        <div class="section__heading mb-2 border-bottom d-flex">
            ...
            <div class="btn_custom mb-2 ">
                <a class="primary__btn rounded shop_more_btn" href="{{route('products.individual.group', ['slug'=>'featured'])}}">Shop More
