                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            <li class="header__menu--items style2">
                                <a class="header__menu--link sticky_menu_link" href="{{ route('index') }}">Home</a>
                            </li>

                            <li class="header__menu--items style2">
                                <a class="header__menu--link sticky_menu_link" href="{{route('products')}}">Shop</a>
                            </li>
                            ...
                            three step categories menu --}}
                            <li class="header__menu--items style2">
                                <a class="header__menu--link sticky_menu_link" href="{{route('wholesale')}}">Wholesale</a>
                            </li>
{{-- headerwithoutsuink --}}
                ...
                <div class="header__menu">
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            @endforeach
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{route('wholesale')}}">Wholesale</a>
                            </li>
                            {{-- three step categories menu
                            @foreach($featured_categories as $category)
                                @if(count($category->menu_child) > 0)
