              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-12 mt-3">
                    <a href="{{ route('order.invoice.generate', $order->id) }}" class="btn btn-primary float-right" style="margin-right: 5px;" target="blank"><i class="fas fa-download" ></i> Print Invoice</a>
                  </div>
                </div>
              </div>
            </div>
