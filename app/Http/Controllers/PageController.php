...
class PageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //$products = Product::where('is_active', 1)->orderBy('id', 'DESC')->limit(10)->get();
        ...
        $featured_categories = Category::where('is_featured', 1)->orderBy('position', 'ASC')->limit(8)->get(['id', 'title', 'image']);
        ...
        return view('user.index', compact('trending_products', 'featured_categories', 'sliders','featured_products','blogs'));
